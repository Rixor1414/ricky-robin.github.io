...
// 3. Use the search bar at the top of the page to make sure ƒyour function works.
//console.log(animals)
...
function replace(animals, name1, replacement) {
    for (var i = 0; i < animals.length; i++){
        if (animals[i].name === name1){
